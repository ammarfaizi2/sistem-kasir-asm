...
;  };
;
%define SIZE_DATA_BARANG	(8 + 8 + 64) ; /* Struct */
%define SIZE_NAMA_BARANG	(64)

%define OFF_ID_BARANG		(0)
%define OFF_HARGA_BARANG	(8)
%define OFF_NAMA_BARANG		(16)
...
menu_tambah_barang:
%define stack_alloc	((((SIZE_DATA_BARANG + 0x10 + 0x7) & ~0x7) + 0x8))
%define tmp_buffer	(rsp)
%define data_barang	(rbp - SIZE_DATA_BARANG)
%define harga_barang_p	(data_barang + OFF_ID_BARANG)
%define id_barang_p	(data_barang + OFF_HARGA_BARANG)
%define	nama_barang_p	(data_barang + OFF_NAMA_BARANG)
	push	rbp
	mov	rbp, rsp
	sub	rsp, stack_alloc
	...
	call	my_print
	lea	rdi, [nama_barang_p]
	mov	esi, SIZE_NAMA_BARANG
	call	my_input
